...
class TunableIconVariant(TunableVariant):
    ...
    def __init__(self, default_participant_type=None, icon_pack_safe=False, **kwargs):
        ...
        super().__init__(resource_key=TunableIconFactory(pack_safe=icon_pack_safe), participant=TunableParticipantTypeIconFactory(default_participant_type=default_participant_type), privacy=TunablePrivacyIconFactory(), tradition=TunableHolidayIconFactory(), lifestyle_brand=TunableLifestyleBrandIconFactory(), career_icon_override=TunableCareerIconOverrideIconFactory(), default=default, **kwargs)
