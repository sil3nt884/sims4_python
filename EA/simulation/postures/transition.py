...
class PostureStateTransition(elements.SubclassableGeneratorElement):
    ...
    def _run_gen(self, timeline):
        ...
        if source_state.back != dest_state.back:
            dest_aspect = dest_state.back
...
class PostureTransition(elements.SubclassableGeneratorElement):
    ...
    def _do_transition(self, timeline) -> bool:
        ...
        try:
            ...
            if new_routing_surface is not None:
            ...
            if self._transition_spec is not None and sim.routing_surface is not None and self._transition_spec is not None and self._transition_spec.portal_obj is not None:
