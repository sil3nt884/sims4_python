    ...
    def _calculate_valid_locations(self):
        ...
        for attractor_tuning in self.attractors:
            ...
            for point in sample_points:
                ...
                water_depth_info = WaterDepthInfo(min_water_depth=attractor_tuning.min_water_depth, max_water_depth=attractor_tuning.max_water_depth)
                fgl_context = placement.FindGoodLocationContext(starting_location_for_sample, object_polygons=(placement_polygon,), ignored_object_ids=objects_to_ignore, max_distance=attractor_tuning.placement_radius, terrain_tags=terrain_tags, water_depth_info=water_depth_info, search_flags=placement.FGLSearchFlagsDefault | placement.FGLSearchFlag.ALLOW_GOALS_IN_SIM_POSITIONS | placement.FGLSearchFlag.ALLOW_GOALS_IN_SIM_INTENDED_POSITIONS)
