...
class ParserBase:
    ...
    def parse_declaration(self, i):
        ...
        while j < n:
            ...
            if c in '"\'':
                ...
                elif decltype in frozenset({'element', 'attlist', 'linktype', 'link'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            return j
        if sectName in frozenset({'ignore', 'rcdata', 'cdata', 'include', 'temp'}):
            match = _markedsectionclose.search(rawdata, i + 3)
        elif sectName in frozenset({'if', 'else', 'endif'}):
            ...
            if c == '<':
                ...
                if rawdata[j:j + 4] == '<!--':
                    ...
                    if j < 0:
                        ...
                        if j == -1:
                            return -1
                        if name not in frozenset({'element', 'attlist', 'notation', 'entity'}):
