...
class InteractionQueue(HasTunableFactory, AutoFactoryInit):
    ...
    def _resolve_priority_pressure(self):
        ...
        for interaction in reversed(list(self)):
            ...
            if highest_priority_interaction is not None and (interaction.is_related_to(highest_priority_interaction) or can_displace(highest_priority_interaction, interaction, allow_clobbering=allow_clobbering, use_max_priority=True)):
