...
def visiblename(name, all=None, obj=None):
    if name in frozenset({'__name__', '__version__', '__slots__', '__qualname__', '__package__', '__module__', '__file__', '__date__', '__path__', '__loader__', '__builtins__', '__cached__', '__spec__', '__doc__', '__credits__', '__author__'}):
        return 0
