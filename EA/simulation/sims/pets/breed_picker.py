...
class BreedPickerSuperInteraction(PickerSuperInteraction):
    ...
    def on_choice_selected(self, choice_tag, **kwargs):
        ...
        if breed is not None:
            ...
            (sim_info_list, _) = sim_spawner.SimSpawner.create_sim_infos((sim_creator,), account=actor_sim_info.account, zone_id=actor_sim_info.zone_id, creation_source='cheat: BreedPickerSuperInteraction', household_change_origin=HouseholdChangeOrigin.CHEAT_BREED_PICK_INTER)
