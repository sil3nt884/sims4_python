...
class ChoiceMenu:
    ...
    def is_valid_aop(aop, context, user_pick_target=None, result_override=DEFAULT, do_test=True):
        ...
        if result_override is not DEFAULT:
            ...
            if user_pick_target is not None and user_pick_target.check_affordance_for_suppression(context.sim, aop, user_directed=True, check_option=SuppressionCheckOption.PROVIDED_AFFORDANCE_ONLY):
