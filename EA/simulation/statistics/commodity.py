...
class CommodityState:
    __slots__ = ('_value', '_buff', '_buff_overrides', '_icon', '_icon_overrides', '_fill_level', '_buff_add_threshold', '_data_description', '_data_description_overrides', '_fill_color', '_fill_color_overrides', '_background_color', '_tooltip_icon_list', '_tooltip_icon_list_overrides', 'loot_list_on_enter_always', 'loot_list_on_enter_increasing', 'loot_list_on_enter_decreasing', 'apply_loot_on_load', '_ui_container_animation_increasing', '_ui_container_animation_decreasing', 'body_type_client_level')

    def __init__(self, value=0, buff=None, buff_overrides=None, icon=None, icon_overrides=None, fill_level=None, buff_add_threshold=None, data_description=None, data_description_overrides=None, fill_color=None, fill_color_overrides=None, background_color=None, tooltip_icon_list=None, tooltip_icon_list_overrides=None, loot_list_on_enter_always=None, loot_list_on_enter_increasing=None, loot_list_on_enter_decreasing=None, apply_loot_on_load=False, ui_container_animation_increasing='', ui_container_animation_decreasing='', body_type_client_level=None):
        self._value = value
        self._buff = buff
        ...
        self._fill_color_overrides = fill_color_overrides
...
class Commodity(HasTunableReference, TunedContinuousStatistic, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.STATISTIC)):
    ...
    def _verify_tuning_callback(cls):
        ...
        if cls.visible and (cls.ui_visible_distress_threshold.threshold_value < min_value or cls.ui_visible_distress_threshold.threshold_value > max_value):
    ...
    def instance_required(self):
        if self._buff_handle is not None or self._distress_buff_handle is not None or self.is_visible_commodity():
            return True
        if self.core and not self.initial_as_default:
            return True
    ...
    def start_low_level_simulation(self):
        ...
        if can_simulate or self.is_visible and sim.is_selectable:
    ...
    def _add_buff_from_state(self, commodity_state, apply_buff_loot=True):
        ...
        if owner.is_sim:
            ...
            if self._buff_handle is None and buff_tuning.buff_type._temporary_commodity_info is not None:
    ...
    def _set_state(self, new_state_index, current_value, apply_state_enter_loot=False, send_client_update=True):
        ...
        if old_state_index is not None or apply_state_enter_loot or new_state.apply_loot_on_load:
            ...
            def get_state_loot():
                ...
                elif new_state_index < old_state_index and new_state.loot_list_on_enter_decreasing:
    ...
    def get_tick_relative_to_age_speed_multiplier(self):
        if self._tick_relative_to_age_speed:
            return self.tracker.owner.sim_info.get_speed_multiple_relative_to_normal(self.tracker.owner.sim_info.age)
        else:
            return 1.0
