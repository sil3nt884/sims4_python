...
class AspirationBasic(Milestone, metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.ASPIRATION)):
    ...
    @classmethod
    def setup_aspiration(cls, event_data_tracker, additional_objectives):
        for objective in itertools.chain(cls.objectives, additional_objectives):
