...
lock_instance_tunables(MotherPlantBattleSituation, audio_sting_on_start=None, main_goal_audio_sting=None, situation_display_type_override=SituationDisplayType.VET)