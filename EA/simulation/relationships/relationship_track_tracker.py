...
class RelationshipTrackTracker(RelationshipTrackTrackerBase):
    __slots__ = ('load_in_progress', '_longterm_tracks_locked', '_can_add_reltrack', '_bit_based_decay_modifiers')
